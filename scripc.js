...
class Birthday {
  ...
  resize() {
    // Ajusta el tamaño del canvas para que se llene en toda la pantalla
  ...
  onClick(evt) {
    ...
    // Disminuye la cantidad de fuegos en pantallas más grandes
    let count = random(3, 6); // Aumentamos el número de fuegos en pantallas más grandes
...
function createImage(imageSrc, x, y) {
  ...
  img.style.width = '150px';  // Aumentar tamaño de las imágenes en pantallas grandes
  img.style.height = '150px'; // Aumentar tamaño de las imágenes en pantallas grandes
  img.style.opacity = 1;
...
surpriseBtn.onclick = function() {
  ...
  }, 3000); // Muestra el nombre 3 segundos después
  showBirthdayImages();  // Muestra las imágenes una por una
};

// Añadir un evento de actualización para los fuegos artificiales
