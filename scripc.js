...
// Código para manejar la lógica de la sorpresa
...
// Iniciar la canción en el segundo 44
audio.currentTime = 44;
audio.play();

// Hacer que la canción termine en el minuto 1:20 (80 segundos)
audio.ontimeupdate = function() {
  if (audio.currentTime >= 80) {
    audio.pause(); // Detener la música
    audio.currentTime = 44; // Volver al inicio
...
surpriseBtn.onclick = function() {
    // Mostrar el mensaje y el canvas
    messageDiv.style.display = 'block';
    canvas.style.display = 'block';
    surpriseBtn.style.display = 'none'; // Ocultar el botón
